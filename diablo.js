...
global.ownerNumber = ["085717376113@s.whatsapp.net"]
global.packname = 'Sticker By'
global.author = '彡𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬〽️'
global.prefa = ['','.']
global.mess = {
    wait: 'Tunggu Bwanhh!!',
    succes: 'Gimana Bwanh?',
...
ppuser = 'https://telegra.ph/file/d1bd7f433fb750f57d0ee.jpg'
...
let buttons = [      
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/d1bd7f433fb750f57d0ee.jpg' },
                    caption: `${jiren}`,
...
case 'menfess':
				...
				header = 'hayyy'
					gambar = `https://telegra.ph/file/d1bd7f433fb750f57d0ee.jpg`

				 but = [
					{ urlButton: { displayText: `Subscribe YT`, url : `https://youtube.com/@ryanmods28` } },
            ...
            case 'self': {
                if (!itsMediablo) throw mess.owner
                diablo.public = false
                diablobotwhatsapp.reply('Bot nya mau turu bg😴')
            }
            break
            case 'public': {
                if (!itsMediablo) throw mess.owner
                diablo.public = true
                diablobotwhatsapp.reply('Bot siap melayani orang gabut🗿')
            }
            break 
case 'openai': case 'iyan':{
...
if (!isGroup) return diablobotwhatsapp.reply(`Wajib Dalam Grup`)
diablobotwhatsapp.reply(`Proses..⏳`)
